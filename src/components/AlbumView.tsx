  ...
  return (
    <div className="pb-32 animate-in fade-in zoom-in-95 duration-500">
      ...
      <div className="pt-8 pb-12 px-6 text-center max-w-4xl mx-auto">
        <div className="relative mx-auto w-64 h-64 md:w-80 md:h-80 mb-8 shadow-2xl rounded-md group perspective-1000">
          {data.imageUrl && !imgError ? (
            ...
            <div
              className="w-full h-full rounded-md z-20 relative bg-gradient-to-br from-zinc-800 to-black flex items-center justify-center border border-white/10"
        ...
        <h1 className="font-display text-4xl md:text-6xl font-bold mb-2 text-white tracking-tight drop-shadow-lg">
          {data.title}
        </h1>
        ...
        <div className="flex justify-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-[#1DB954] hover:bg-[#1ed760] text-black text-xs font-bold uppercase tracking-wider py-3 px-6 rounded-full flex items-center gap-2 transition-transform hover:scale-105 shadow-lg shadow-green-900/30"
          >
            <SpotifyIcon /> Listen
          </a>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-white hover:bg-gray-200 text-black text-xs font-bold uppercase tracking-wider py-3 px-6 rounded-full flex items-center gap-2 transition-transform hover:scale-105 shadow-lg shadow-white/20"
          >
      ...
      <div className="max-w-3xl mx-auto px-5 space-y-12">
        ...
        <section
          id="overview"
          className="scroll-mt-24 grid grid-cols-2 md:grid-cols-4 gap-4 glass-card p-6 rounded-2xl border-t-4"
        ...
        >
          ...
          <div>
            ...
            <div className="text-sm font-medium">{data.genre}</div>
          </div>
        </section>
        ...
        <section id="vision" className="scroll-mt-24">
          <h3 className="font-display text-2xl font-bold mb-4 flex items-center gap-2">
            <Mic2 className="text-white/50" size={20} /> The Concept
          </h3>
          <div className="glass-card p-8 rounded-2xl bg-gradient-to-br from-white/5 to-transparent relative overflow-hidden">
            ...
            <div className="mt-4 pt-4 border-t border-white/10">
              <h4 className="text-xs uppercase tracking-widest text-white/50 mb-2 font-bold">
                Themes
              </h4>
          ...
          <div className="mt-4 glass-card p-4 rounded-xl flex gap-4 items-start">
            ...
            <div>
              <h4 className="text-sm font-bold uppercase text-white/80">
                Cover Art Story
              </h4>
              ...
              {tracklist.map((track, i) => (
                ...
                >
                  <div className="flex items-baseline gap-3 mb-1">
                    ...
                    <h4 className="font-bold text-white/90 text-base group-hover:text-blue-200 transition-colors">
                      {track.track}
                    </h4>
                  </div>
                  <p className="text-sm text-white/50 pl-9 group-hover:text-white/70 transition-colors line-clamp-2">
                    {track.description}
                  </p>
                </button>
              ))}
        ...
        <section
          id="timeline"
          className="scroll-mt-24 grid grid-cols-1 md:grid-cols-2 gap-6"
        >
          <div className="glass-card p-6 rounded-2xl">
            ...
            <div className="text-xs uppercase text-white/30 font-bold mb-1">
              Tour Era
            </div>
          ...
          <div
            id="reception"
            className="glass-card p-6 rounded-2xl scroll-mt-24"
          >
        ...
        <section className="glass-card p-6 rounded-2xl bg-gradient-to-r from-blue-900/10 to-purple-900/10 border border-white/10">
          ...
          <div className="space-y-3 text-sm">
            <p>
              <span className="text-white/50 font-bold">Collaborators:</span>{" "}
              <span className="text-white/80">{data.collaborators}</span>
            </p>
            <p>
              <span className="text-white/50 font-bold">Easter Eggs:</span>{" "}
              <span className="text-white/80">{data.hiddenDetails}</span>
            </p>
          </div>
        </section>
