...
const SongView: React.FC<SongViewProps> = ({
  ...
  const appleMusicLink = `https://music.apple.com/us/search?term=${encodeURIComponent(
    data.title + " " + data.artist
  )}`;
    ...
    <div className="pb-32 min-h-screen">
      ...
      <div className="sticky top-0 z-50 bg-black/80 backdrop-blur-xl border-b border-white/10 shadow-2xl relative">
        <div className="overflow-x-auto no-scrollbar py-3 px-4 flex gap-4 transition-all duration-300">
          <button
            onClick={onBack}
            className="flex-shrink-0 p-1.5 bg-white/10 rounded-full mr-2 hover:bg-white/20 transition-colors"
          >
            <svg
              width="16"
              height="16"
          ...
          {SECTIONS.map((section) => (
            <button
              ...
              className={`flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider whitespace-nowrap transition-all duration-300 ${activeSection === section.id
      ...
      <div className="relative w-full h-[60vh] md:h-[70vh] overflow-hidden group">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent flex flex-col justify-end p-6 md:p-12 z-10">
          <RevealOnScroll className="mb-4 flex flex-wrap gap-2">
            <span className="px-3 py-1 bg-white/20 backdrop-blur-md rounded-full text-xs font-bold uppercase tracking-widest text-white/90 border border-white/10 shadow-lg">
              {data.genre}
            </span>
            <span className="px-3 py-1 bg-black/40 backdrop-blur-md rounded-full text-xs text-white/70 border border-white/5">
              {data.year}
            </span>
          </RevealOnScroll>
          <RevealOnScroll delay={100}>
            <h1 className="font-display text-5xl md:text-8xl font-black leading-none mb-4 text-white drop-shadow-2xl">
              {data.title}
            </h1>
          </RevealOnScroll>
          <RevealOnScroll delay={200}>
            <div className="font-serif text-2xl md:text-3xl italic text-white/90 flex items-center gap-2 mb-8">
              ...
              <button
                ...
                className="hover:text-blue-300 hover:underline decoration-blue-300/50 underline-offset-4 transition-all"
              >
                {data.artist}
              </button>
            </div>
          ...
          <RevealOnScroll delay={300} className="flex flex-wrap gap-4 pb-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex-1 min-w-[140px] max-w-[200px] bg-[#1DB954] hover:bg-[#1ed760] text-black font-bold py-3 px-6 rounded-xl flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-95 transition-all shadow-lg shadow-green-900/40"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex-1 min-w-[140px] max-w-[200px] bg-white hover:bg-gray-100 text-black font-bold py-3 px-6 rounded-xl flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-95 transition-all shadow-lg shadow-white/20"
            >
      ...
      <div className="max-w-4xl mx-auto px-5 md:px-8 relative z-20 space-y-16 pt-10">
        ...
        <RevealOnScroll>
          <section id="snapshot" className="scroll-mt-32">
            <div
              className="glass-card p-6 md:p-10 rounded-[2rem] border-l-8 overflow-hidden relative group"
            ...
            >
              ...
              <p className="font-display text-3xl md:text-4xl font-medium leading-tight text-white mb-10 drop-shadow-md relative z-10">
                {data.hook}
              </p>

              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8 border-t border-white/10 relative z-10">
                <div>
                  <div className="text-white/40 text-[10px] uppercase mb-2 font-bold tracking-widest">
                    Album
                  </div>
                  <div className="font-bold text-base text-white">
                    {data.quickFacts?.album || "Single"}
                  </div>
                </div>
                <div>
                  <div className="text-white/40 text-[10px] uppercase mb-2 font-bold tracking-widest">
                  ...
                  <div className="font-bold text-base text-white">
                    {data.quickFacts?.writers || data.artist}
                  </div>
                </div>
                <div>
                  <div className="text-white/40 text-[10px] uppercase mb-2 font-bold tracking-widest">
                  ...
                  <div className="font-bold text-base text-white">
                    {data.quickFacts?.producers || "Various"}
                  </div>
                </div>
                <div>
                  <div className="text-white/40 text-[10px] uppercase mb-2 font-bold tracking-widest">
        ...
        <RevealOnScroll>
          <section id="backstory" className="scroll-mt-32">
            <div className="flex items-center gap-4 mb-8">
              <div className="p-4 bg-white/5 rounded-2xl text-white border border-white/10 shadow-lg">
                <BookOpen size={24} />
              </div>
              <h2 className="font-display text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-white/60">
                Origin Story
              </h2>
            </div>
        ...
        <RevealOnScroll>
          <section id="meaning" className="scroll-mt-32">
            <div className="flex items-center gap-4 mb-8">
              <div className="p-4 bg-purple-500/10 rounded-2xl text-purple-300 border border-purple-500/20">
                <Globe size={24} />
              </div>
            ...
            <div className="glass-card p-8 md:p-10 rounded-[2rem] bg-gradient-to-br from-purple-900/20 to-transparent border border-white/5 shadow-2xl relative overflow-hidden">
              ...
              <p className="text-xl leading-relaxed text-zinc-200 relative z-10">
                {data.meaningAndThemes}
              </p>
            </div>
          </section>
        </RevealOnScroll>
        ...
        <section id="lyrics" className="scroll-mt-32 space-y-8">
          <RevealOnScroll>
            <div className="flex items-center gap-4 mb-6">
              <div className="p-4 bg-blue-500/10 rounded-2xl text-blue-300 border border-blue-500/20">
                <Quote size={24} />
              </div>
              <h2 className="font-display text-4xl font-bold">
                Lyrics Deep Dive
          ...
          {lyricsMoments.length > 0 ? (
              ...
              {lyricsMoments.map((moment, idx) => (
                <RevealOnScroll key={idx} delay={idx * 100}>
                  <div className="relative pl-8 md:pl-10 border-l-2 border-blue-500/30 py-2 group hover:border-blue-500 transition-colors duration-500">
                    <p className="font-serif italic text-2xl md:text-3xl text-white mb-4 group-hover:text-blue-100 transition-colors">
                      "{moment.line}"
                    </p>
            ...
            <div className="glass-card p-6 rounded-2xl text-center text-white/50 italic">
              Explore the full lyrics analysis below to uncover the hidden
              meanings.
            </div>
          )}
          ...
          <RevealOnScroll className="mt-8">
            ...
            {lyricsError && (
              <div className="w-full py-4 rounded-2xl bg-red-500/10 border border-red-500/20 flex items-center justify-center gap-2 text-red-200">
                <AlertCircle size={20} />
                <span>
                  Couldn't analyze lyrics at this moment. Please try again.
                </span>
                <button
                  onClick={handleRevealLyrics}
            ...
            {fullLyrics && Array.isArray(fullLyrics) && (
              <div className="mt-10 space-y-12 animate-in fade-in slide-in-from-bottom-10 duration-700">
                {fullLyrics.map((segment, i) => (
                  <div
                    key={i}
                    className="flex flex-col md:flex-row gap-6 md:gap-12 pb-12 border-b border-white/5 last:border-0 last:pb-0"
                  >
                    {/* Lyrics Column */}
                    <div className="md:w-5/12">
                      <h4 className="text-xs uppercase font-bold tracking-widest text-blue-400 mb-4 sticky top-32">
                        {segment.section}
                      </h4>
        ...
        <RevealOnScroll>
          <section
            id="production"
            className="scroll-mt-32 glass-card p-8 md:p-10 rounded-[2rem] bg-zinc-900/50"
          >
            <div className="flex items-center gap-4 mb-8">
              <div className="p-4 bg-green-500/10 rounded-2xl text-green-300 border border-green-500/20">
                <Headphones size={24} />
              </div>
            ...
            {data.artistCommentary && (
              <div className="bg-white/5 p-8 rounded-3xl border border-white/5 relative">
                <Quote
                  className="absolute top-6 left-6 text-white/10 transform -scale-x-100"
                  size={48}
                />
                <div className="text-xs uppercase tracking-widest text-white/40 mb-4 font-bold relative z-10 pl-2">
                  Artist Commentary
                </div>
                <p className="font-serif italic text-xl md:text-2xl text-white/90 relative z-10 pl-2">
                  "{data.artistCommentary}"
                </p>
              </div>
            )}
        ...
        <RevealOnScroll>
          <section id="impact" className="scroll-mt-32">
            <div className="flex items-center gap-4 mb-8">
              <div className="p-4 bg-yellow-500/10 rounded-2xl text-yellow-300 border border-yellow-500/20">
                <Award size={24} />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {versions.length > 0 && (
                <div className="glass-card p-8 rounded-[2rem] hover:bg-white/5 transition-colors duration-500">
                  <h4 className="font-bold mb-6 flex items-center gap-3 text-sm uppercase tracking-widest text-white/50">
                    <Radio size={18} /> Versions & Covers
                  </h4>
        ...
        {trivia.length > 0 && (
          <RevealOnScroll>
            <section className="bg-gradient-to-br from-zinc-900 to-black rounded-[2rem] p-8 md:p-12 border border-white/5 shadow-2xl relative overflow-hidden">
              ...
              <h3 className="font-display text-2xl font-bold mb-8 text-white relative z-10">
                Did You Know?
              </h3>
              <ul className="space-y-6 relative z-10">
                {trivia.map((t, i) => (
                  <li key={i} className="flex gap-4 text-zinc-400">
                    <span className="text-blue-400 select-none text-2xl leading-none">
                      •
                    </span>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {sources.map((source, i) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-white/5 hover:bg-white/10 text-xs text-white/50 hover:text-white transition-colors"
                >
