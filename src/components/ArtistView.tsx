    ...
    <div className="pb-32 animate-in fade-in slide-in-from-bottom-8 duration-700">
      ...
      <div className="relative h-[60vh] w-full">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/30 to-transparent p-6 md:p-10 flex flex-col justify-end">
          <h1 className="font-display text-5xl md:text-8xl font-black text-white tracking-tighter mb-4 drop-shadow-xl">
            {name.toUpperCase()}
          </h1>
          <p className="text-xl md:text-2xl text-white/90 font-serif italic max-w-2xl drop-shadow-md">
            {data.bio}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 mt-10 space-y-12">
        ...
        <div className="flex flex-wrap gap-3 justify-center text-sm font-bold uppercase tracking-wider text-white/60 mb-8">
          <span className="px-5 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
            {data.yearsActive || "Active"}
          </span>
          <span className="px-5 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
            {data.origin || "Unknown Origin"}
          </span>
          <span className="px-5 py-2 rounded-full border border-white/10 text-white bg-white/10">
            {data.genre || "Music"}
          </span>
        </div>
        ...
        <section id="bio" className="scroll-mt-24">
          ...
          <div
            className="glass-card p-8 rounded-3xl space-y-6 border-l-4"
            style={{ borderLeftColor: themeColor }}
          >
            <div>
              <h4 className="text-xs uppercase tracking-widest text-white/50 mb-3 font-bold">
                Early Life
              </h4>
        ...
        <section
          id="style"
          className="scroll-mt-24 glass-card p-8 rounded-3xl bg-gradient-to-br from-purple-900/20 to-transparent"
        >
          <div className="flex items-center gap-3 mb-4 text-purple-300">
            <Music2 size={28} />
            <h3 className="font-bold text-2xl font-display text-white">
              Musical DNA
            </h3>
          </div>
        ...
        {trivia.length > 0 && (
          <section
            id="trivia"
            className="scroll-mt-24 bg-white/5 p-8 rounded-3xl border border-white/5"
          >
            ...
            <ul className="space-y-4">
              {trivia.map((fact, i) => (
                <li
                  key={i}
                  className="glass-card p-4 rounded-xl text-sm text-white/80 border-l-4 border-orange-400/50"
                >
                  {fact}
                </li>
              ))}
